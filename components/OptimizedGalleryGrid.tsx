...
export default function OptimizedGalleryGrid({ items, title }: OptimizedGalleryGridProps) {
      ...
      <div className="container max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item) => (
            ...
            >
              <div className="relative w-full aspect-square bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-700">
              ...
              <div className="p-4 bg-white dark:bg-gray-900">
                <p className="font-semibold text-[color:var(--ink)] line-clamp-2">{item.title}</p>
              </div>
            </div>
          ))}
        </div>
